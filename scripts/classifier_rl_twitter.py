...
def sample_sentiment140(path, n_pos=100, n_neg=100, chunksize=200_000, random_state=42):
    """
...
def train_rl_detector_system(train_sequences, test_sequences, labels, n, r, episodes=20):
    ...
    for episode in range(episodes):
        ...
        print(f" Chosen action = {action} (ε={epsilon:.3f})")
        ...
        print(f" Generated {len(dets)} detectors")
